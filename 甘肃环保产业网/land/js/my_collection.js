...
//							点击取消收藏的hover事件
                             $(".personal_r_x .pageDiv_r").hover(function(){
                             	 $(this).find(".time").css({display:"none"})
                             	 $(this).find(".tupian").css({display:"block"})
                             	 
                             	 $(this).find(".tupian").click(function(){
//                           	 	获取到这个的什么值传入后台,在重新刷新页面
                                    alert("你以取消这个收藏了")
                             	 ...
                             	 $(this).find(".tupian").css({display:"none"})
                             })
...
function pageIm() {
	...
	$(".pageBox").pageFun({ /*在本地服务器上才能访问哦*/
		...
		dataFun: function(data) {
			var dataHtml = "<li><p><a href='" + data.href + "'>" + data.mingchang + "</a></p><p class='pageDiv_r'><span class='time'>" + data.time + "</span> <span class='tupian'><img src='../images/quxiao.png'/></span></p></li>"
			return dataHtml;
		},
		pageFun: function(i) {
