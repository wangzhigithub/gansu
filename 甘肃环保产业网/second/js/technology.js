$(function() {
	...
	page(true);
    //	传入type参数  true->全部    /0->绿色之星   / 1->  环境认证产品/ 2->产品注册登记 / 3->国家示范工程 / 4->重点实用技术 / 5->省优秀环保工程
...
function pageIm() {
	...
	$(".pageBox").pageFun({ /*在本地服务器上才能访问哦*/
				...
				dataFun: function(data) {
					var dataHtml = "<li><span><a href=''>" + data.title + "</a></span><span>" + data.time + "</span></li>"
					return dataHtml;
				},
				pageFun: function(i) {
